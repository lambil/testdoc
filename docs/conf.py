...
exclude_patterns = ['_build','valid_login.rst']
...
texinfo_documents = [
  ('index', 'robot', u'robot Documentation',
   u'JL', 'robot', 'One line description of project.',
   'Miscellaneous'),
]
...
#  html_theme_path = [sphinx_rtd_theme.get_html_theme_path()]
  ...
  sphinxcontrib_robotframework_variables = { 'BROWSER': 'Firefox' }
